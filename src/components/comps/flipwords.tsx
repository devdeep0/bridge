  ...
  return (
    <div className="h-[40rem] w-full flex justify-center items-center px-4 ">
      <div className="text-2xl mx-auto overflow-hidden font-normal text-neutral-600 dark:text-neutral-400">
        <div className="text-5xl text-black mb-2 font-semibold flex flex-col dark:text-white"> NodeBridge <div>Empowering Africa <span className="italic font-bold text-blue-500">Node by Node</span></div></div>
