...
export function FlipWordsDemo() {
  ...
  return (
    <div className="h-[40rem] flex justify-center items-center px-4 ">
      <div className="text-2xl mx-auto overflow- font-normal text-neutral-600 dark:text-neutral-400">
        <div className="text-5xl text-white mb-4 font-semibold flex flex-col">Welcome to NodeBridge: <div>Empowering Africa <span className="italic font-bold text-blue-500">Node by Node</span></div></div>
